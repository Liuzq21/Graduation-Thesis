...
\subsection{高密度光盘回读模型优化}

\section{光盘读通道噪声与串扰特性研究现状}
...
\subsection{噪声与串扰的抑制技术前期探索}


\section{光盘读通道均衡技术研究现状}
\subsection{传统均衡技术发展}
